...
class Params
{
  public:
    ...
    #elif MARK == 0
    // orignal detection range
    const float min_x_range = 0.0;   // 0.0
    const float max_x_range = 69.12;  // 69.12
    const float min_y_range = -39.68; // -39.68
    const float max_y_range = 39.68;  // 39.68
    const float min_z_range = -3.0;   // -3.0
    const float max_z_range = 1.0;    // 1.0
    #endif
