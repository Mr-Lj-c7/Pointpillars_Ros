...
class DetectedObject(genpy.Message):
  _md5sum = "1dec60ffb07ad8ad2f992318dc4d859e"
...
"""
  __slots__ = ['header','id','track_id','label','score','color','valid','space_frame','pose','dimensions','variance','velocity','acceleration','pointcloud','convex_hull','pose_reliable','velocity_reliable','acceleration_reliable','image_frame','x','y','width','height','angle','roi_image','indicator_state','behavior_state','user_defined_info']
  _slot_types = ['std_msgs/Header','uint32','uint32','string','float32','std_msgs/ColorRGBA','bool','string','geometry_msgs/Pose','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Twist','geometry_msgs/Twist','sensor_msgs/PointCloud2','geometry_msgs/PolygonStamped','bool','bool','bool','string','int32','int32','int32','int32','float32','sensor_msgs/Image','uint8','uint8','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,track_id,label,score,color,valid,space_frame,pose,dimensions,variance,velocity,acceleration,pointcloud,convex_hull,pose_reliable,velocity_reliable,acceleration_reliable,image_frame,x,y,width,height,angle,roi_image,indicator_state,behavior_state,user_defined_info
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.id, _x.track_id))
      _x = self.label
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.track_id,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
